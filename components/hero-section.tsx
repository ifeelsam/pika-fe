      ...
      <div className="w-full max-w-7xl mx-auto">
        ...
        <div ref={buttonRef} className="relative group opacity-0">
          <Button
            ...
            className="bg-pikavault-yellow sm:hover:bg-pikavault-yellow/90 text-pikavault-dark text-lg md:text-xl font-bold py-6 px-12 rounded-none transition-all duration-300 overflow-hidden sm:group-hover:translate-x-1 sm:group-hover:-translate-y-1 font-monument"
          >
            EXPLORE COLLECTION
            <span className="absolute inset-0 bg-pikavault-pink mix-blend-overlay opacity-0 sm:group-hover:opacity-30 transition-opacity duration-300"></span>
          </Button>
          <div className="absolute inset-0 border-2 border-pikavault-yellow -z-10 translate-x-2 translate-y-2 sm:group-hover:translate-x-4 sm:group-hover:translate-y-4 transition-all duration-300"></div>
        </div>
      </div>
